...
class Edit extends \Chalhoub\ShopFinder\Controller\Adminhtml\ShopFinder
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('chalhoub_shopfinder_shopfinder', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? __('Edit Shopfinder %1', $model->getId()) : __('New Shopfinder'));
        return $resultPage;
    }
}
