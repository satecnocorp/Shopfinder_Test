...
class ShopFinderActions extends \Magento\Ui\Component\Listing\Columns\Column
{
    ...
    const URL_PATH_DELETE = 'chalhoub_shopfinder/shopfinder/delete';
    const URL_PATH_DETAILS = 'chalhoub_shopfinder/shopfinder/details';
    protected $urlBuilder;
    const URL_PATH_EDIT = 'chalhoub_shopfinder/shopfinder/edit';
